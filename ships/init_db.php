 ...
 * CREATE THE DATABASE
 */
$pdoDatabase = new PDO('mysql:host=localhost:3307', $databaseUser, $databasePassword);
 ...
 * CREATE THE TABLE
 */
$pdo = new PDO('mysql:host=localhost:3307;dbname='.$databaseName, $databaseUser, $databasePassword);
...
$pdo->exec('INSERT INTO ship
    ...
    ("Jedi Starfighter", 5, 15, 31, "rebel")'
);
$pdo->exec('INSERT INTO ship
    (name, weapon_power, jedi_factor, strength, team) VALUES
